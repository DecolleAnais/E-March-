...
\end{DoxyReturn}
\hypertarget{class_utilisateur_abe5d38ac1992f3db28b29f985be40ff9}{\index{Utilisateur@{Utilisateur}!delete\-Achat@{delete\-Achat}}
\index{delete\-Achat@{delete\-Achat}!Utilisateur@{Utilisateur}}
\subsubsection[{delete\-Achat}]{\setlength{\rightskip}{0pt plus 5cm}void Utilisateur\-::delete\-Achat (
\begin{DoxyParamCaption}
\item[{{\bf Produit} $\ast$}]{p}
\end{DoxyParamCaption}
)}}\label{class_utilisateur_abe5d38ac1992f3db28b29f985be40ff9}
...
\begin{DoxyParams}{Paramètres}
{\em p} & -\/ Pointeur vers le nouveau produit à supprimer des achats \\
\hline
\end{DoxyParams}
\hypertarget{class_utilisateur_a55a91e468128dd5bacc995c3c91e4000}{\index{Utilisateur@{Utilisateur}!delete\-Vente@{delete\-Vente}}
\index{delete\-Vente@{delete\-Vente}!Utilisateur@{Utilisateur}}
\subsubsection[{delete\-Vente}]{\setlength{\rightskip}{0pt plus 5cm}void Utilisateur\-::delete\-Vente (
\begin{DoxyParamCaption}
\item[{{\bf Produit} $\ast$}]{p}
\end{DoxyParamCaption}
)}}\label{class_utilisateur_a55a91e468128dd5bacc995c3c91e4000}
...
\begin{DoxyParams}{Paramètres}
{\em p} & -\/ Pointeur vers le nouveau produit à supprimer des ventes \\
\hline
\end{DoxyParams}
