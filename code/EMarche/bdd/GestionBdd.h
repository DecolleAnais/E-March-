...
public:
    ...
    //!
    //! \fn std::vector<Utilisateur*> rechercherUtilisateurs(std::string pseudo)
    //! \brief recherche les utilisateurs contenant ce pseudo
    //! \param pseudo - pseudo recherché
    //! \return vector de pointeurs vers les utilisateurs trouvés
    //!
